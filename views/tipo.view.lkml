view: tipo {
  sql_table_name: `replica_claveteo_pro_db.tipo` ;;
...
view: tipo__datastream_metadata__sort_keys {

  dimension: tipo__datastream_metadata__sort_keys {
    type: string
    sql: tipo__datastream_metadata__sort_keys ;;
  }
}
